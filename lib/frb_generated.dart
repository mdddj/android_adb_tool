...
abstract class RustLibApi extends BaseApi {
  Future<String> crateApiToolAdbDeviceExecuteHostCommand(
      {required AdbDevice that,
      required String shell,
      required bool hasOutput,
      required bool hasLen});

  Future<String> crateApiToolAdbDeviceExecuteHostShellCommand(
      {required AdbDevice that, required String shell});

  Future<DeviceTcpStream> crateApiToolDeviceHostConnect(
      {required DeviceHost that});

  Future<AdbDevice> crateApiToolDeviceHostConnectToDevice(
      {required DeviceHost that});

  Future<List<AdbDeviceInfo>> crateApiToolDeviceHostDevices(
      {required DeviceHost that});
...
class AdbDeviceImpl extends RustOpaque implements AdbDevice {
  ...
  Future<String> executeHostShellCommand({required String shell}) => RustLib
      .instance.api
